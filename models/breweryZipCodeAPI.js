  ...
  request(queryURL, function (error, response, body) {
    ...
    if (!error && response.statusCode === 200) {
      ...
      for (var i = 0; i < JSON.parse(body).data.length; i++) {
        ...
        console.log(i + 'th element of external Breweries Array: ' + breweriesArray[i].latitude);
        console.log(i + 'th element of external Breweries Array brand classification: ' + breweriesArray[i].brewery.brandClassification);
      }
    }
  });
}
