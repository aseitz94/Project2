...
var userZip = document.getElementById("place-event").val();
var userRadius = document.getElementById("radius-event").val();
...
function getBreweriesZip(zipCode, userRadius, breweries) {
...
getBreweriesZip(userZip, userRadius, breweriesArray);
